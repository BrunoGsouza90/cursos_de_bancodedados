...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos` (
  ...
  INDEX `fk_fabricante_1_idx` (`id_fabricante` ASC),
  CONSTRAINT `fk_produto_1`
    FOREIGN KEY (`id_tipo_produto`)
    REFERENCES `farmacia`.`tipos_produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fabricante_1`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`compras` (
  ...
  `data` DATE NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_compras_cliente_1_idx` (`id_cliente` ASC),
  CONSTRAINT `fk_compras_cliente_1`
...
CREATE TABLE IF NOT EXISTS `farmacia`.`produtos_compra` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produto_compra_1_idx` (`id_compra` ASC),
  INDEX `fk_produto_produto_1_idx` (`id_produto` ASC),
  CONSTRAINT `fk_produto_compra_1`
    FOREIGN KEY (`id_compra`)
    REFERENCES `farmacia`.`compras` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto_produto_1`
